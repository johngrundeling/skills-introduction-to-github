...
**Audience & eligibility:** the assessment is distributed to **congregation
members who have completed the New Believers Course** and desire to serve — **not**
the 12 Advance Team members. Who *receives* the link is controlled in **GHL**
(send only to the New-Believers-complete segment). The registration page also
carries a **required prerequisite/commitment checkbox** (New Believers Course
completed + a holy, reliable, consistent walk); confirming it tags the contact
`usher-nbc-attested` in GHL. Note this is a distinct list from the **leadership
completion-notification** (`LEADERSHIP_*`), which goes to the Advance Team /
Head Usher / Pastors.
